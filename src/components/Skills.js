...
import {SiLeetcode,SiJavascript,SiMicrosoftsqlserver,SiNodedotjs,SiDotnet,SiReact,SiHtml5,SiCss3,SiBootstrap,SiMongodb,SiExpress,SiDjango , SiCplusplus} from 'react-icons/si'
function Skills() {
  return (
    <Fragment>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            <h1 className="font-big text-red slide-in-top">Technologies and Tools </h1>
                            <hr></hr>
